    ...
    <SparklesPreview>
      ...
      >
        <div className="relative flex w-full flex-1 items-center justify-center isolate z-0">
          ...
          <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-green-100 dark:bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#0a0015] via-[#00150e] to-black opacity-90 blur-2xl"></div>
          <div className="absolute top-1/2 z-50 h-48 w-full bg-green-100 dark:bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#0a0015] via-[#00150e] to-black opacity-10 backdrop-blur-md"></div>
          ...
          <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-green-100 dark:bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-[#0a0015] via-[#00150e] to-black opacity-25"></div>
        </div>
